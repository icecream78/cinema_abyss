...
Прогон postman тестов можно посмотреть в рамках ![скриншота](./screens/run_results.jpg).
Результаты в kafka UI в рамках ![скришота](./screens/kafka_run_results.jpg) и информацию о топике movie ![скришот](./screens/kafka_topic.jpg)
Часть лога по обработке событий врамках ![скришота](./screens/msg_handle_log.jpg)
...
В рамках задания как и требовалось, был доработан CI/CD процесс сборки контейнеров ![скришот](./screens/ci_cd_success_overview.jpg). Пример зеленых тестов ![скришот](./screens/ci_cd_success_tests.jpg) и зеленой сборки контейнеров ![скришот](./screens/ci_cd_success_build.jpg)


### Proxy в Kubernetes

Полностью настроенная и функционирующая инфраструктура cinemaabyss представлена на скриншоте ![kube infra](./screens/kubernetes_infra.jpg).
Для доказательста работоспособности решения, был сделан вызов https://cinemaabyss.example.com/api/movies с уже настроенным ingress controller, котоырй можно увидеть на скриншоте ![ingress](./screens/ingress_result.jpg).
Успешынй прогон postman тестов на kubernetes кластере + обработка событий events можно увидеть на скриншоте ![kube tests](./screens/kubernetes_tests_result.jpg)
